        ...
        {transcription ? (
          <Stack spacing={3}>
            <Typography variant="body2" color="text.secondary">
              <FormattedMessage defaultMessage="Send this transcription to the OS Voice team so we can review what went wrong. Your data is only shared with the OS Voice team and never with third parties. Adding a note below helps us understand and fix the issue." />
            </Typography>

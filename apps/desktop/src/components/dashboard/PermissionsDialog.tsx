...
const getPurposeDescription = (
  ...
  const descriptions: Record<PermissionKind, string> = {
    microphone: intl.formatMessage({
      defaultMessage:
        "Allows OS Voice to capture audio from your microphone for transcription.",
    }),
      ...
      <DialogContent>
        <Stack spacing={3}>
          <Typography variant="body1">
            <FormattedMessage defaultMessage="OS Voice is an AI dictation tool. It needs microphone and accessibility access in order to function properly." />
          </Typography>
          <Stack>

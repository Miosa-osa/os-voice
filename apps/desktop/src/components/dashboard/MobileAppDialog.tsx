    ...
    <Dialog open={open} onClose={closeMobileAppDialog} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          <FormattedMessage defaultMessage="Scan a QR code below to download OS Voice on your phone. Let us know on Discord if you have any feedback! We're actively building out these apps." />
        </Typography>
        <Stack
          direction="row"

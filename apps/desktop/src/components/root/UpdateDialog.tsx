        ...
        <Stack spacing={2} sx={{ mt: 1 }}>
          ...
          {isLinux && (
            <Stack spacing={1.5}>
                  ...
                  values={{
                    link: (
                      <Link
                        component="button"
                        variant="body2"
                        onClick={() => openUrl("https://osa.dev/download")}
              ...
              <Typography variant="caption" color="text.secondary">
                <FormattedMessage defaultMessage="After updating, restart OS Voice to use the new version." />
              </Typography>
            </Stack>
          )}
          ...
          {!isLinux &&
            ...
            (requiresManualInstall ? (
              <Alert severity="success" variant="outlined">
                <FormattedMessage defaultMessage="The installer has been opened. Follow the prompts to complete the update, then relaunch OS Voice." />
              </Alert>
            ) : (
              ...
              <Stack spacing={1}>
                ...
                {showManualInstallerAction && (
                  <Typography variant="body2">
                    <FormattedMessage defaultMessage="Your operating system is preventing OS Voice from modifying files in its current install location. Use the download button to get the latest installer, then run it to complete the update manually." />
                  </Typography>
                )}
              </Stack>
            </Alert>

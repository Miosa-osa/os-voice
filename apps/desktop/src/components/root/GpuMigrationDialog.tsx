      ...
      <DialogContent>
        <Stack spacing={2} sx={{ mt: 0.5 }}>
          <Alert severity="warning" variant="outlined">
            <FormattedMessage defaultMessage="The GPU version of OS Voice will no longer receive updates." />
          </Alert>
          ...
          <Stack component="ol" spacing={1} sx={{ pl: 2, mb: 0 }}>
            <Typography component="li" variant="body2" color="text.secondary">
              <FormattedMessage defaultMessage="Uninstall the OS Voice GPU app." />
            </Typography>
            <Typography component="li" variant="body2" color="text.secondary">

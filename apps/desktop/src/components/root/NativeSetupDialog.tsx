    ...
    <Dialog open={open} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        {phase === "idle" && (
          <Stack spacing={2}>
            <Typography>
              <FormattedMessage defaultMessage="OS Voice needs to install and configure some tools to work correctly on Wayland. You'll be prompted for your password in order to complete installation." />
            </Typography>
            <Typography variant="body2" color="text.secondary">
              <FormattedMessage defaultMessage="OS Voice needs ydotool to paste text into your apps on Wayland. This will install the package, grant the necessary permissions, and start a background service." />
            </Typography>
          </Stack>
        )}
        {phase === "running" && (
        ...
        {phase === "require-restart" && (
          <Typography>
            <FormattedMessage defaultMessage="All done! Log out and log back in for the permissions to take effect, then reopen OS Voice." />
          </Typography>
        )}
        {phase === "failed" && (

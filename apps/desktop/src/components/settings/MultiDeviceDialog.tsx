...
export const MultiDeviceDialog = () => {
  ...
  const handleCopyInvite = async () => {
    ...
    if (!invite) {
      showErrorSnackbar(
        "Enable the multi-device receiver first so OS Voice can generate an invite.",
      );
      return;
    }
            ...
            {(receiverStatus?.enabled ?? false) && (
              <>
                <SettingSection
                  ...
                  description={
                    <FormattedMessage defaultMessage="Leave blank to auto-assign a port, or set a fixed port and apply it immediately. If the receiver is running, OS Voice will restart it for you." />
                  }
                  action={
                ...
                <SettingSection
                  ...
                  description={
                    <FormattedMessage defaultMessage="When enabled, OS Voice will start the multi-device receiver automatically on launch using the saved receiver port." />
                  }
                  action={
                    <Switch
                      edge="end"
                  ...
                  <Stack spacing={0.5} sx={{ mt: -1 }}>
                    ...
                    {lastTargetLooksLikeVoquill && (
                      <Typography
                        ...
                        sx={{ wordBreak: "break-word" }}
                      >
                        <FormattedMessage defaultMessage="The last delivery targeted the OS Voice window itself. Focus the destination app on the receiver machine before sending text." />
                      </Typography>
                    )}
        ...
        <DialogContent dividers>
          <Stack spacing={2} sx={{ pt: 0.5 }}>
            <Typography variant="body2" color="text.secondary">
              <FormattedMessage defaultMessage="Paste the invite copied from the receiver machine. OS Voice will trust both devices automatically." />
            </Typography>
            <TextField

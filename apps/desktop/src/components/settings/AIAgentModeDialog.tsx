    ...
    <>
      ...
      >
        ...
        <DialogContent>
          ...
          >
            <FormattedMessage defaultMessage="By enabling power mode, you accept full responsibility for any actions taken by the assistant. OS Voice is not liable for any consequences resulting from commands executed on your system." />
          </Typography>
        </DialogContent>
        <DialogActions>
          ...
          <Stack spacing={3} alignItems="flex-start">
            ...
            >
              <Stack spacing={0.5} flex={1}>
                ...
                <Typography variant="body2" color="text.secondary">
                  <FormattedMessage defaultMessage="Allow the assistant to run terminal commands on your behalf. This is a temporary guardrail that will be removed in a future update. Restart OS Voice to apply changes." />
                </Typography>
              </Stack>
              <Switch
